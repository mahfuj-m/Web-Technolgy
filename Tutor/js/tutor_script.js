	...
	//document.getElementById("updateName").value = id;	
			  ...
			  xhttp.onreadystatechange = function() {
			    if (this.readyState == 4 && this.status == 200) {
			    	...
			    	document.getElementById("updateName").value = data.tutor_name;
			    	document.getElementById("updateid").value = data.id;
			    	document.getElementById("updateemail").value = data.email;
			    	document.getElementById("updatemobile").value = data.mobile;
			    	document.getElementById("updatesubject").value = data.subjects;
			  ...
			  xhttp.open("GET", "../Tutor/Class/Tutor_Ajax.php?q="+id, true);
			  xhttp.send();
         }
