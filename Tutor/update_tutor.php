      ...
      $cookie_name = $_POST['upName'];
       setcookie($cookie_name, $cookie_value, time() + (86400 * 30), "/"); 
          ...
          $data = array(
            ...
            'subjects'   => $_POST['upsubject'],
            'day'   => $_POST['upday'],
            'language'   => $_POST['uplang'],
            'email'  =>$_POST['upemail']
             );
          foreach ($data as $key => $value) {
              $sql = "UPDATE `tutor` SET `$key` = '$value' WHERE `tutor`.`id` = ".$id;
              $m->tutor_update($sql);
          }
  ...
  <tbody>
                          ...
                          <?php
                            ...
                            foreach ($tutors as $i => $value) {
                              ...
                              echo "<td>" . $tutors[$i]['tutor_name'] . "</td>";
                              echo "<td>" . $tutors[$i]['email'] . "</td>";
                              echo "<td>" . $tutors[$i]['mobile'] . "</td>";
                             echo "<td>" . $tutors[$i]['subjects']. "</td>";
